...
public class TreeBlocksAndItems extends VariantsOfTypesCombo<EnumTree>
{
	...
	static
	{
		Predicate<EnumTree> billet = EnumTree::hasBillet;
		...
		BRANCH.setVariantFilter(EnumTree::isBush);
		...
		DEAD_LOG.setCreativeTab(GenesisCreativeTabs.DECORATIONS).setVariantFilter(EnumTree::hasDead);
	...
	{
		super("trees", TYPES,
				EnumTree.class, ImmutableList.copyOf(EnumTree.values()));
