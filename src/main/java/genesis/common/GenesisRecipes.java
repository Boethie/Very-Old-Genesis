...
public final class GenesisRecipes {
    public static void addRecipes() {
        GameRegistry.addShapelessRecipe(new ItemStack(GenesisItems.flint_and_marcasite), Metadata.createStack(EnumNodule.MARCASITE), Metadata.createStack(EnumPebble.BROWN_FLINT));
        GameRegistry.addShapelessRecipe(new ItemStack(GenesisItems.flint_and_marcasite), Metadata.createStack(EnumNodule.MARCASITE), Metadata.createStack(EnumNodule.BROWN_FLINT));
        ...
        GameRegistry.addSmelting(GenesisBlocks.brown_flint_ore, Metadata.createStack(EnumNodule.BROWN_FLINT), 0.05F);
        GameRegistry.addSmelting(GenesisBlocks.marcasite_ore, Metadata.createStack(EnumNodule.MARCASITE), 0.05F);
