...
public final class GenesisRecipes
{
	...
	public static void addRecipes()
	{
		...
		// Peat
		ItemStack peat = GenesisItems.MATERIALS.getStack(EnumMaterial.PEAT);
		GameRegistry.addRecipe(new ItemStack(GenesisBlocks.PEAT),
						"CC",
						"CC",
						'C', peat);

		// Peat brick
		ItemStack peatBrick = GenesisItems.MATERIALS.getStack(EnumMaterial.PEAT_BRICK);
		GameRegistry.addRecipe(new ItemStack(GenesisBlocks.PEAT_BRICK),
						"CC",
						"CC",
						'C', peatBrick);
