...
public final class GenesisRecipes
{
	...
	public static void addRecipes()
	{
		...
		GameRegistry.addShapedRecipe(new ItemStack(GenesisBlocks.torch), "x", "y", 'x', Items.coal, 'y', GenesisItems.calamites);
		GameRegistry.addShapedRecipe(new ItemStack(GenesisBlocks.torch), "x", "y", 'x', new ItemStack(Items.coal, 1, 1), 'y', GenesisItems.calamites);
		GameRegistry.addShapedRecipe(new ItemStack(GenesisBlocks.torch), "x", "y", 'x', GenesisItems.resin, 'y', GenesisItems.calamites);
