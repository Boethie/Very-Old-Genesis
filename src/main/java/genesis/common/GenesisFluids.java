...
public class GenesisFluids
{
	...
	public static final Fluid KOMATIITIC_LAVA = new Fluid(Unlocalized.PREFIX+"komatiiticlava", new ResourceLocation(Constants.ASSETS+"blocks/komatiitic_lava_still"),
