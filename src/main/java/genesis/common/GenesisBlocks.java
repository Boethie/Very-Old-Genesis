...
public final class GenesisBlocks {
    ...
    /* Limestone Ores */
    public static final Block brown_flint_ore = new BlockGenesisOre(1, 0).setDrop(MetadataUtils.createStack(EnumNodule.BROWN_FLINT)).setUnlocalizedName(Constants.PREFIX + "oreBrownFlint").setHardness(1.5F).setResistance(4.35F);
    public static final Block marcasite_ore = new BlockGenesisOre(1, 0).setDrop(MetadataUtils.createStack(EnumNodule.MARCASITE)).setUnlocalizedName(Constants.PREFIX + "oreMarcasite").setHardness(1.5F).setResistance(4.35F);
