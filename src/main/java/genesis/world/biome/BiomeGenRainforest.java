...
public class BiomeGenRainforest extends BiomeGenBaseGenesis
{
	...
	protected void addDecorations()
	{
		...
		addDecoration(new WorldGenBoulders(0.055F, 3, 1).setRadius(FloatRange.create(0.75F, 1.5F), FloatRange.create(0.25F, 0.75F)), 1.35F);
	...
	protected void addTrees()
	{
		...
		addTree(new WorldGenTreeLepidodendron(14, 20, true).generateVine(10), 20);
