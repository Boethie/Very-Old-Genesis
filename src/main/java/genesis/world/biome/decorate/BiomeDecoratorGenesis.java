...
import genesis.metadata.EnumGraniteOre;
...
public class BiomeDecoratorGenesis extends BiomeDecorator
{
	...
	public void decorate(World world, Random random, BiomeGenBase biome, BlockPos chunkStart)
	{
		...
		else
		{
			...
			quartzGen = new WorldGenMinableGenesis(GenesisBlocks.graniteOres.getOreState(EnumGraniteOre.QUARTZ), 4, 8);
			zirconGen = new WorldGenMinableGenesis(GenesisBlocks.graniteOres.getOreState(EnumGraniteOre.ZIRCON), 1, 4);
			garnetGen = new WorldGenMinableGenesis(GenesisBlocks.graniteOres.getOreState(EnumGraniteOre.GARNET), 1, 4);
