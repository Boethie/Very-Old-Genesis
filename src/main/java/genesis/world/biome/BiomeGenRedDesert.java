...
public class BiomeGenRedDesert extends BiomeGenBaseGenesis
{
	public BiomeGenRedDesert(BiomeGenBase.BiomeProperties properties)
	{
		...
		addDecoration(new WorldGenSplash(t->t.getBlock() != Blocks.air, GenesisBlocks.silt.getBlockState(SiltBlocks.SILT, EnumSilt.RED_SILT), GenesisBlocks.silt.getBlockState(SiltBlocks.CRACKED_SILT, EnumSilt.RED_SILT)), 8f);
