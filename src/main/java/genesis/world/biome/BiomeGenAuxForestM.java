...
public class BiomeGenAuxForestM extends BiomeGenAuxForest
{
	...
	protected void addDecorations()
	{
		...
		addDecoration(new WorldGenRockBoulders(GenesisBlocks.rhyolite.getDefaultState()).setWaterRequired(false).setMaxHeight(3).setRarity(8).setCountPerChunk(1));
		addDecoration(new WorldGenRockBoulders(GenesisBlocks.dolerite.getDefaultState()).setWaterRequired(false).setMaxHeight(3).setRarity(8).setCountPerChunk(1));
