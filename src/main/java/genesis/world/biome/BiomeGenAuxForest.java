...
public class BiomeGenAuxForest extends BiomeGenBaseGenesis
{
	...
	protected void addDecorations()
	{
		...
		addDecoration(new WorldGenPlant(EnumPlant.SANMIGUELIA).setNextToWater(true).setPatchSize(4).setCountPerChunk(18));
	...
	protected void addTrees()
	{
		...
		addTree(new WorldGenTreeGinkgo(12, 17, false).setTreeCountPerChunk(1).setRarity(4));
