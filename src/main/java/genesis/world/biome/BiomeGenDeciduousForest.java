...
public class BiomeGenDeciduousForest extends BiomeGenBaseGenesis
{
	...
	protected void addTrees()
	{
		...
		addTree(new WorldGenTreeDryophyllum(11, 15, false).setTreeCountPerChunk(12));
		addTree(new WorldGenTreeDryophyllum(13, 17, false).setType(TreeTypes.TYPE_2).setTreeCountPerChunk(1).setRarity(15));
