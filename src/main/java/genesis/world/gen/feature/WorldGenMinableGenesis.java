...
public class WorldGenMinableGenesis extends WorldGenerator {
	...
	public WorldGenMinableGenesis(Block p_i45459_1_, int p_i45459_2_) {
		this(p_i45459_1_, p_i45459_2_, null);
		singleStone = false;
	}

	public WorldGenMinableGenesis(Block p_i45460_1_, int p_i45460_2_, Block p_i45460_3_) {
						...
						if (d12 * d12 + d13 * d13 < 1.0D) {
							for (int i3 = k1; i3 <= j2; ++i3) {
								...
								if (d12 * d12 + d13 * d13 + d14 * d14 < 1.0D) {
									...
									if (singleStone) {
										if (par1World.getBlockState(thisPos).getBlock() == stone) {
											//TODO: Get the ore stuff working.
											//par1World.setBlockState(thisPos, this.ore, mineableBlockMeta, 2);
										}
									} else if (par1World.getBlockState(thisPos) instanceof BlockGenesisRock) {
										//par1World.setBlockState(thisPos, this.ore, mineableBlockMeta, 2);
									}
								}
							}
