...
public class WorldGenMinableSurface extends WorldGenerator {
	...
	public WorldGenMinableSurface(Block p_i45459_1_, int p_i45459_2_) {
		this(p_i45459_1_, p_i45459_2_, GenesisBlocks.moss);
	}

	public WorldGenMinableSurface(Block p_i45460_1_, int p_i45460_2_, Block p_i45460_3_) {
		this.ore = p_i45460_1_;
		this.numberOfBlocks = p_i45460_2_;
		this.stone = p_i45460_3_;
	}

	public WorldGenMinableSurface(Block block, int meta, int number, Block target) {
	...
	public boolean generate(World par1World, Random par2Random, BlockPos pos) {
		...
		double d4 = (double) (pos.getY() + par2Random.nextInt(3) - 2);
		double d5 = (double) (pos.getY() + par2Random.nextInt(3) - 2);
						...
						if (d12 * d12 + d13 * d13 < 1.0D) {
							for (int i3 = k1; i3 <= j2; ++i3) {
								...
								if (d12 * d12 + d13 * d13 + d14 * d14 < 1.0D) {
									...
									if (par1World.getBlockState(thisPos).getBlock() == stone && par1World.getTopSolidOrLiquidBlock(thisPos).getY() == l2 + 1) {
										//TODO: Get ores working.
