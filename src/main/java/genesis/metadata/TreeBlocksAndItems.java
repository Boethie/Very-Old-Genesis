...
public class TreeBlocksAndItems extends VariantsOfTypesCombo<EnumTree>
{
	...
	public static final ObjectType<BlockGenesisRottenLogs, ItemBlockMulti<EnumTree>> ROTTEN_LOG = new ObjectType<BlockGenesisRottenLogs, ItemBlockMulti<EnumTree>>("rotten_log", "log.rotten", BlockGenesisRottenLogs.class, null, EnumTree.PSARONIUS)
