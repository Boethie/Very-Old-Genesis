...
public class BlockDung extends BlockGenesisVariants<EnumDung>
{
	...
	public boolean canHarvestBlock(IBlockAccess world, BlockPos pos, EntityPlayer player) {
		...
		return held != null && held.getItem().getHarvestLevel(held, getHarvestTool(state), player, state) >= getHarvestLevel(state);
	}
	...
	public boolean isFullCube(IBlockState state) {
		return ready && state.getValue(HEIGHT) >= MAX_HEIGHT;
	}
