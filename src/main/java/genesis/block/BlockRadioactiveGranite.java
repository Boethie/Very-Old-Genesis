...
public class BlockRadioactiveGranite extends BlockGenesisRock
{
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, ItemStack heldItem, EnumFacing side, float hitX, float hitY, float hitZ)
	{
		if(heldItem!=null)
		{
			playerIn.addChatMessage(new TextComponentString(Item.itemRegistry.getNameForObject(heldItem.getItem()).toString()));
			playerIn.addChatMessage(new TextComponentString("With meta: "+heldItem.getMetadata()));
		}
		return true;
	}
}
