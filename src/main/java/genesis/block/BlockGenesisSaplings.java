...
public class BlockGenesisSaplings extends BlockSapling
{
	...
	public void generateTree(World world, BlockPos pos, IBlockState state, Random rand)
	{
		...
		case METASEQUOIA:
			...
			minHeight = (treeType == TreeTypes.TYPE_2)? 22 : 17;
			maxHeight = (treeType == TreeTypes.TYPE_2)? 27 : 23;
		...
		case GINKGO:
			...
			minHeight = (treeType == TreeTypes.TYPE_2)? 13 : 10;
			maxHeight = (treeType == TreeTypes.TYPE_2)? 17 : 12;
		...
		case DRYOPHYLLUM:
			...
			maxHeight = (treeType == TreeTypes.TYPE_2)? 20 : 13;
