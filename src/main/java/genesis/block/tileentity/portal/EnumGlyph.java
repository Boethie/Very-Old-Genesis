...
public enum EnumGlyph implements IMetadata<EnumGlyph>
{
	...
	VEGETAL("vegetal",
			...
			GenesisItems.menhir_activators.getStack(EnumMenhirActivator.SHIMMERING_TREE_STAR)),
	ANIMAL("animal",
			GenesisItems.menhir_activators.getStack(EnumMenhirActivator.FOSSILIZED_EGG),
			GenesisItems.menhir_activators.getStack(EnumMenhirActivator.SHADY_DRAGON_BONE)),
	HOMINID("hominid",
			GenesisItems.menhir_activators.getStack(EnumMenhirActivator.BROKEN_SPIRIT_MASK),
			GenesisItems.menhir_activators.getStack(EnumMenhirActivator.LEGENDARY_SPECTRUM_EYE)),
	COSMOS("cosmos",
